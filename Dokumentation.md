...
/Volumes/Extreme Pro/encho-music-production/aal-g-latte/remotion-static-videos/public/03-semplicemente/01-il-pescatore

// 03 Semplicemente

npx remotion render Visualizer out/03-semplicemente/01-il-pescatore.mp4 \
  --props=./renderProps/03-semplicemente/01-il-pescatore.json

npx remotion render Visualizer out/03-semplicemente/02-deine-liebe-klebt.mp4 \
  --props=./renderProps/03-semplicemente/02-deine-liebe-klebt.json

npx remotion render Visualizer out/03-semplicemente/03-pane-e-sale.mp4 \
  --props=./renderProps/03-semplicemente/03-pane-e-sale.json



example - only 60 frames for testing rendering:
